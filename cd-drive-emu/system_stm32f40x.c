...
/* 
 * 重定义 PLL_M 以适配不同的主时钟晶振值的分频, 
 * PLL 频率  = HSE_VALUE / PLL_M * PLL_N
 * PLL 输出P = PLL 频率 / PLL_P
 * 保证 "PLL 输出P" = 168 MHz
 */
#if defined(PLL_M_RE_VAL)
  #undef  PLL_M
  #define PLL_M  PLL_M_RE_VAL
#endif
#if defined(PLL_N_RE_VAL)
  #undef  PLL_N
  #define PLL_N  PLL_N_RE_VAL
#endif
#if defined(PLL_P_RE_VAL)
  #undef  PLL_P
  #define PLL_P  PLL_P_RE_VAL
#endif
